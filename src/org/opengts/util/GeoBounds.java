    ...
    implements Cloneable
{
    ...
    **/
    public GeoBounds(GeoPolygon poly)
    {
        this.extendByPolygon(poly);
    }
    ...
    **/
    ...
    /**
    *** Extend the bounds by the specified GeoPolygon
    *** @param poly  The GeoPolygon added to the bounds
    **/
    public void extendByPolygon(GeoPolygon poly)
    {
        if (GeoPolygon.isValid(poly)) {
            this.extendByPoint(poly.getGeoPoints());
        }
    }
    ...
    **/
    ...
    /**
    *** Returns the "Middle" point of the bounds
    *** @return The GepPoint representing the "Middle" point of the bounds
    **/
