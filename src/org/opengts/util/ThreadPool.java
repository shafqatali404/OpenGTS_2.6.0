...
public class ThreadPool
{
    ...
    ***                 done).
    **/
    public static void StopThreads(boolean stopNow) // shutdown
    {
        synchronized (ThreadPool.threadPoolList) {
            if (stopNow) {
    ...
    *** @param dftMaxIdleSec The default maximum number of idle seconds.
    **/
    ...
    **/
    public void stopThreads() // shutdown
    {
    ...
    ***                 done).
    **/
    public void stopThreads(boolean stopNow) // shutdown
    {
        synchronized (this.jobQueue) {
