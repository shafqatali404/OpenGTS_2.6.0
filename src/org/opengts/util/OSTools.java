...
public class OSTools
{
    ...
    **/
    public static String[] createJavaCommand(String javaArgs[], Classpath classpath, String className, String classArgs[])
    {
    ...
    *** @param javaArgs   The command and arguments to execute
    **/
    public static void execJava(String className, String javaArgs[], StringBuffer outSB, StringBuffer errSB)
    {
        String javaCmd[] = OSTools.createJavaCommand(null, null, className, javaArgs);
