    ...
    implements Cloneable
{
    ...
    **/
    ...
    /**
    *** Returns true if this polygon is valid 
    ...
    **/
    ...
    /**
    *** Returns true if the specified polygon is valid
    *** @return True if the polygon is valid
    **/
    public static boolean isValid(GeoPolygon poly)
    {
        return ((poly != null) && poly.isValid())? true : false;
    }
    ...
    *** Negative polygons counts are listed within parenthesis.
    *** IE. 234(5,10,6)
    *** @return A String representation of the number of points this polygon contains.
    **/
    ...
    **/
    ...
    {
        return this.getPointCountString();
    }

    // ------------------------------------------------------------------------

    /**
    *** Returns a String representation of this GeoPolygon suitable for using as a
    *** PostgreSQL/PostGIS "polygon" data type.
    *** Format is "((LON,LAT),(LON,LAT),...)"
    **/
    public StringBuffer toPostgres_polygon(StringBuffer sb)
    {
        if (sb == null) { sb = new StringBuffer(); }
        GeoPoint  gps[] = this.getGeoPoints();
        sb.append("(");
        if (gps != null) {
            for (int g = 0; g < gps.length; g++) {
                if (g > 0) { sb.append(","); }
                gps[g].toPostgres_point(sb);
            }
        }
        sb.append(")");
        return sb;
    ...
    **/
    ...
    {
        return !ListTools.isEmpty(this.negRings);
    }
