    ...
    implements Comparable<RTKey>
{
    ...
    public static final String URL_CONNECT_TIMEOUT          = "url.connect.timeout"; //milliseconds
    public static final String URL_READ_TIMEOUT             = "url.read.timeout"; //milliseconds
    
    public static final String DNS_CACHE_TIMEOUT            = "dns.cache.timeout"; // seconds
    ...
    public static final String SMTP_SERVER_RETRY_COUNT      = "smtp.retryCount";
    ...
    public static final String ServerSocketThread_maximumClientThreadPoolSize = "ServerSocketThread.maximumClientThreadPoolSize"; // Integer
    public static final String ServerSocketThread_udpReceiveBufferSize        = "ServerSocketThread.udpReceiveBufferSize"; // Integer
    ...
    protected static Entry runtimeKeys[] = {
        ...
        new Entry("DNS attributes"),
        new Entry(DNS_CACHE_TIMEOUT          , -2                               , "DNS cache timeout (sec)"),                   // APP
