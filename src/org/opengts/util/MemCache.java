    ...
    implements MemCacheAPI<KEY,VAL>
{
    ...
    public  static final int        MINIMUM_CACHE_SIZE      = 100;
    ...
    public  static final double     MAX_MEMORY_UTILIZATION  = 0.80;
        ...
        implements MemCacheAPI<KEY,VAL>
    {
        ...
        public void trimCache(String msg) {
            ...
            if (memUtilPct >= MAX_MEMORY_UTILIZATION) {
                ...
                if (memUtilPct > (MAX_MEMORY_UTILIZATION - 0.15)) {
                    ...
                    Print.logWarn("TrimCache["+msg+"]: Excess memory usage ["+this.cutbackCount+"@"+currSize+"], max size reset to "+newMax);
