...
public class Print
{
    ...
    **/
    ...
    /**
    *** Returns the specified Throwable stack-trace as a String.
    *** If specified Throwable is null, the stack-track of the current stack frame will be returned
    *** @param msg   The message included to identify the stack-trace
    *** @param th    The Throwable instance from which the stack-trace is obtained
    *** @return The String representation of the stack-trace
    **/
    public static String getStackTraceString(String msg, Throwable th)
    {
        ByteArrayOutputStream bos = new ByteArrayOutputStream();
        PrintStream bosOut = new PrintStream(bos);
        int nextFrame = 1;
        Print._printStackTrace(bosOut, nextFrame, msg, th);
        bosOut.close(); // not necessary
        return bos.toString();
    }
