...
public class HTMLTools
{
  ...
  //public  static final byte   MAGIC_MOV[]                 = new byte[]{(byte)0x00,(byte)0x00,(byte)0x00,(byte)0x14,(byte)0x66,(byte)0x74,(byte)0x79,(byte)0x70,(byte)0x71,(byte)0x74,(byte)0x20,(byte)0x20}; // unverified
    ...
    ***/
    ...
    {
        URL pageURL = new URL(pageURLStr);
        return readPage_GET(pageURL, timeoutMS, -1/*maxLen*/);
    }
    ...
    *** @throws IOException if an I/O error occurs
    ***/
    public static byte[] readPage_GET(String pageURLStr, int timeoutMS, int maxLen)
        throws Throwable
    {
        URL pageURL = new URL(pageURLStr);
        return readPage_GET(pageURL, timeoutMS, maxLen);
    }
    ...
    *** @throws IOException if an I/O error occurs
    ***/
    public static byte[] readPage_GET(URL pageURL, int timeoutMS, int maxLen)
        throws Throwable
    {
        byte data[] = null;
        HttpURLConnection httpConnect = null;
