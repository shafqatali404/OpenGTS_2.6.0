...
public class FileTools
{
    ...
    private static boolean _initFilesGetAttribute()
    {
        ...
        synchronized (FilesGetAttribute_initLock) {
            if (!FilesGetAttribute_didInit) { // check again after lock
                ...
                Class linkOptClass = null; // java.nio.file.LinkOption
                try {
                    pathClass    = Class.forName("java.nio.file.Path");
                    linkOptClass = Class.forName("java.nio.file.LinkOption");
    ...
    **/
    ...
    private static final String ARG_FILE[]          = new String[] { "file"       , "f"        };    // File
    private static final String ARG_ATTR[]          = new String[] { "attr"       , "a"        };    // File
    ...
    private static final String ARG_OVERWRITE[]     = new String[] { "overwrite"               };    // boolean
    private static final String ARG_TIMEOUT[]       = new String[] { "timeoutMS"  , "timeout"  };    // int
    ...
    **/
    public static void main(String argv[])
    {
        ...
        boolean progress = RTConfig.getBoolean("progress",!quiet);
