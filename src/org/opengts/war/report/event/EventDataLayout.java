    ...
    extends ReportLayout
{
  ...
  //public static final String  DATA_APPLIED_PRESSURE   = "appliedPressure";
    ...
    public static final String  DATA_TIRE_TEMPERATURE_1 = "tireTemp01";             // C
    public static final String  DATA_TIRE_TEMPERATURE_2 = "tireTemp02";             // C
    public static final String  DATA_TIRE_TEMPERATURE_3 = "tireTemp03";             // C
    public static final String  DATA_TIRE_TEMPERATURE_4 = "tireTemp04";             // C
    public static final String  DATA_TIRE_TEMPERATURE_5 = "tireTemp05";             // C
    public static final String  DATA_TIRE_TEMPERATURE_6 = "tireTemp06";             // C
    public static final String  DATA_TIRE_TEMPERATURE_7 = "tireTemp07";             // C
    public static final String  DATA_TIRE_TEMPERATURE_8 = "tireTemp08";             // C
    public static final String  DATA_TIRE_TEMPERATURE_9 = "tireTemp09";             // C
    public static final String  DATA_TIRE_TEMPERATURE_A = "tireTemp10";             // C
        ...
        extends DataRowTemplate
    {
        public EventDataRow() {
                ...
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    if (rowNdx >= 0) {
                        ...
                        if (arg.equalsIgnoreCase("googleMap") ||
                            ...
                            ColumnValue cv = new ColumnValue();
                            cv.setValue(" "+ndxVal+" ");
                            cv.setLinkURL(mapURL.toString(),"_blank"/*target*/);
                            return cv;
                        } else
                        if (arg.charAt(0) == '0') {
            ...
            */
            ...
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_1) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 0;
                    double C[] = ed.getTireTemp_C();
                    if (ListTools.size(C) > cNdx) {
                        return EventDataLayout.formatTemperature(C[cNdx], arg, rd, "?");
                    } else {
                        return rc.getBlankFiller();
                    }
                }
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(0);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_2) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 1;
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(1);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_3) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 2;
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(2);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_4) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 3;
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(3);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_5) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 4;
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(4);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_6) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 5;
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(5);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_7) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 1;
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(6);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_8) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 7;
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(7);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_9) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 8;
                ...
                public String getTitle(ReportData rd, ReportColumn rc) {
                    I18N i18n = rd.getPrivateLabel().getI18N(EventDataLayout.class);
                    String cNdxS = String.valueOf(8);
                    return i18n.getString("EventDataLayout.tireTemperatureN","Tire Temp\n#{0}", cNdxS);
                }
            });
            this.addColumnTemplate(new DataColumnTemplate(DATA_TIRE_TEMPERATURE_A) {
                public Object getColumnValue(int rowNdx, ReportData rd, ReportColumn rc, Object obj) {
                    String arg = rc.getArg();
                    EventData ed = (EventData)obj;
                    int   cNdx = 9;
