    ...
    extends ReportData
{
    ...
    private static final String PROP_selectByWhereOnly  = "selectByWhereOnly";
    ...
    **/
    public DBDataIterator getBodyDataIterator()
    {
        ...
        boolean selectByWhereOnly = rtp.getBoolean(PROP_selectByWhereOnly, false);

        /* get array of EventData records */
        EventData ed[] = null;
        DBRecordHandler<EventData> rcdHandler = null;
        if (selectByWhereOnly) {
            // -- select events based on "super.getWhereSelector()" only
            // -  will return an empty array if specified "where" is null/blank
