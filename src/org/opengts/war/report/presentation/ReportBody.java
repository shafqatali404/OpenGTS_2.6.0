...
public class ReportBody
{
        ...
        throws ReportException
    {
        ...
        /* report totals */
        DBDataIterator totals = (report != null)? report.getTotalsDataIterator() : null;
    ...
    public void writeXML(PrintWriter out, int level, ReportData report)
        throws ReportException
    {
        boolean isSoapRequest = (report != null)? report.isSoapRequest() : false;
    ...
    *** @param rd      The Report attributes (must not be null)
    **/
        ...
        throws ReportException
    {
        ...
        /* get callback method */
        ReportCallback rptCB = (rd != null)? rd.getReportCallback() : null;
        if (rptCB == null) {
            return;
        }

        /* report body */
        DBDataIterator data = (rd != null)? rd.getBodyDataIterator() : null;
        if ((data != null) && data.hasNext()) {
        ...
        /* report totals */
        DBDataIterator totals = (rd != null)? rd.getTotalsDataIterator() : null;
        if ((totals != null) && totals.hasNext()) {
