...
// ----------------------------------------------------------------------------
// Examples:
//  <gts:var if="pageName" value="menu.top" compare="NE"> ... </gts:var>
//  <gts:var ifElse="isLoggedIn" value="true"> ... </gts:var>
// Notes:
//  - The body of <gts:var ...> ... </gts:var> cannot contain nested <gts:var>
//    or <gts:track ...> specifications.
// ----------------------------------------------------------------------------
// Change History:
  ...
  //private static final String KEY_START               = "@@{";
    ...
    **/
    ...
    private boolean _compare(String ct, String cv, String kv)
    {
        ...
        //Print.logInfo("Compare: "+kv+" "+ct+" "+cv+" ==> "+match);
        return match;
    }
        ...
        throws JspTagException
    {
        ...
        try {
            if (this.isMatch()) {
                ...
                //Print.logInfo("Ending tag body: " + body);
            } else
            if (this.hasElse()) {
