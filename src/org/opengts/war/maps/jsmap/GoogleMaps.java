    ...
    extends JSMap
{
    ...
    **/
    ...
    {
        String appVers = this.getApiVersion();
        return appVers.equalsIgnoreCase("cb");
    }
    ...
    **/
    ...
    {
        String appVers = this.getApiVersion();
        return appVers.equalsIgnoreCase("js");
    }
    ...
    **/
        ...
        throws IOException
    {
        ...
        // -- places
        JavaScriptTools.writeJSVar(out, "GOOGLE_PLACES_NEARBY"    , placesNearby);
        JavaScriptTools.writeJSVar(out, "GOOGLE_NEARBY_TYPES"     , nearbyTypes);
        JavaScriptTools.writeJSVar(out, "GOOGLE_PLACES_SEARCH"    , placesSearch);
        ...
        throws IOException 
    {
        ...
        if (StringTools.isBlank(mapCtlURL)) {
            ...
            if (this.isVersionCB()) {
                ...
                sb.append("maps.googleapis.com/maps/api/js?sensor=false"); // &callback=initMap");
            } else
            if (this.isVersionJS()) {
                // -- generic JavaScript
