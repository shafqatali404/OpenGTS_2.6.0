    ...
    implements ReverseGeocodeProvider, SubdivisionProvider, GeocodeProvider
{
    ...
    protected static       String HOST_PRIMARY_FREE             = "api.geonames.org";
    protected static       String HOST_PRIMARY_PREMIUM          = "ws.geonames.org";
    protected static       String HOST_PRIMARY_PREMIUM_2        = "ws.geonames.net";

    protected static       String HOST_PRIMARY                  = HOST_PRIMARY_FREE;
    protected static       String HOST_PRIMARY_2                = HOST_PRIMARY_PREMIUM_2;
    ...
    **/
    protected String getHostname(boolean primary)
    {
        ...
        if (StringTools.isBlank(host) || host.equalsIgnoreCase("default")) {
            // -- return default host
          //return this.hasUsername()? HOST_PRIMARY_2 : HOST_PRIMARY;
            return HOST_PRIMARY;
        } else {
    ...
    **/
    private ReverseGeocode createAddress(Map<String,String> addrProps, double maxAddressDistanceKM)
    {
        ...
        if (isUS && (state.length() > 2)) {
            String stateAbbr = USState.getStateCodeForName(state,null);
