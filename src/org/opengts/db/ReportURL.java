...
public class ReportURL
{
    ...
    public enum Format implements EnumTools.IntValue, EnumTools.StringValue {
        HTML     (  0, ReportURL.FORMAT_HTML     ),    // MIME: "text/html" (default)
        XML      (  1, ReportURL.FORMAT_XML      ),    // MIME: "text/xml"
        CSV      (  2, ReportURL.FORMAT_CSV      ),    // MIME: "text/csv"
        XLS      (  3, ReportURL.FORMAT_XLS      ),    // MIME: "application/vnd.ms-excel"
        XLSX     (  4, ReportURL.FORMAT_XLSX     ),    // MIME: "application/vnd.ms-excel"
        TXT      (  5, ReportURL.FORMAT_TXT      ),    // MIME: "text/plain" (csv format)
        SOAP     (  6, ReportURL.FORMAT_SOAPXML  ),    // 
        EHTML    (  7, ReportURL.FORMAT_EHTML    ),    // 
        CUSTOM   (  8, ReportURL.FORMAT_CUSTOM   ),    // 
        SCHEDULE (  9, ReportURL.FORMAT_SCHEDULE ),    // 
        URL      ( 10, ReportURL.FORMAT_URL      ),    // 
        EMAIL    ( 11, ReportURL.FORMAT_EMAIL    ),    // 
        CALLBACK ( 12, ReportURL.FORMAT_CALLBACK ),    // 
        PDF      ( 13, ReportURL.FORMAT_PDF      );    // 
        // ---
        private int      vv = 0;
