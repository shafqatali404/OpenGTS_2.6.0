...
//     -Initial release
//  2015/09/18  Martin D. Flynn
//     -Added MOBILEID, EVENTCODE field types
// ----------------------------------------------------------------------------
...
public interface CustomParser
{
    ...
    public static final String  MOBILEID    = "$mobileid";  // String
    public static final String  EVENTCODE   = "$eventcode"; // String
