...
// OBC/J1708/CANBUS status: 0xF900 to 0xF9FF
    ...
    // Description:
    //      OBC/J1708 Temperature (coolant) out-of-range
    ...
    // Description:
    //      OBC/J1708 Engine coolent level/temp out-of-range

    public static final int STATUS_OBD_COOLANT_OK       = 0xF92D;   // 63789
    // Description:
    //      OBC/J1708 Engine coolent level/temp normal/restored
...
// ----------------------------------------------------------------------------
    ...
    **/
    ...
    private static Code _codeArray[] = new Code[] {
        ...
        new Code(STATUS_SPEEDING_LIMIT_1    , "SPEED.LIMIT.1", I18N.getString(StatusCodes.class,"StatusCodes.speedingLimit_1"   ,"Speeding_Limit 1" ), true ),
        new Code(STATUS_SPEEDING_LIMIT_2    , "SPEED.LIMIT.2", I18N.getString(StatusCodes.class,"StatusCodes.speedingLimit_2"   ,"Speeding_Limit 2" ), true ),
        new Code(STATUS_SPEEDING_LIMIT_3    , "SPEED.LIMIT.3", I18N.getString(StatusCodes.class,"StatusCodes.speedingLimit_3"   ,"Speeding_Limit 3" ), true ),
        new Code(STATUS_SPEEDING_LIMIT_4    , "SPEED.LIMIT.4", I18N.getString(StatusCodes.class,"StatusCodes.speedingLimit_4"   ,"Speeding_Limit 4" ), true ),
      ...
      //new Code(STATUS_STATE_EXIT          , "STA.EXIT"     , I18N.getString(StatusCodes.class,"StatusCodes.stateExit"         ,"State_Exit"       ), true ), // (off) 
        ...
        new Code(STATUS_ONLINE              , "ONLINE"       , I18N.getString(StatusCodes.class,"StatusCodes.online"            ,"Online"           )       ), // (off) 
        new Code(STATUS_OFFLINE             , "OFFLINE"      , I18N.getString(StatusCodes.class,"StatusCodes.offline"           ,"Offline"          )       ), // (off) 
        new Code(STATUS_LIGHTING_CHANGED    , "LIGHT_CHANGE" , I18N.getString(StatusCodes.class,"StatusCodes.lightingChanged"   ,"Lighting_Changed" )       ), // (off) 
        new Code(STATUS_LIGHTING_BRIGHTER   , "LIGHT_BRIGHT" , I18N.getString(StatusCodes.class,"StatusCodes.lightingBright"    ,"Lighting_Bright"  )       ), // (off) 
        new Code(STATUS_LIGHTING_DARKER     , "LIGHT_DARK"   , I18N.getString(StatusCodes.class,"StatusCodes.lightingDark"      ,"Lighting_Dark"    )       ), // (off) 
