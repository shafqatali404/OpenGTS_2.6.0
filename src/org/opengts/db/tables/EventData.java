    ...
    implements EventDataProvider, GeoPointProvider
{
    ...
    **/
    ...
    public static final DBField GPSFieldInfo[] = {
        ...
        new DBField(FLD_sequence         , Integer.TYPE  , DBField.TYPE_INT32       , I18N.getString(EventData.class,"EventData.fld.sequence"           , "Packet Sequence"       ), ""),
    };
  ...
  //public static final String FLD_appliedPressure      = "appliedPressure";        // kPa
    ...
    **/
    ...
    {
        return this.getFieldValue(FLD_sequence, -1);
    }
    ...
    **/
    ...
    {
        this.setFieldValue(FLD_sequence, v);  // may be signed
    }
    ...
    **/
        ...
        throws SlowOperationException
    {
        ...
        if (geocoderMode.isNone()) {
            // -- no geocoding is performed for this EventData
        ...
        if (gzone != null) {
            ...
            updFields.add(EventData.FLD_subdivision);
            if (gzone.supportsSpeedLimitKPH()) {
        ...
        if (geocoderMode.isGeozone()) { // (!geocoderMode.okPartial())
    ...
    **/
    ...
    // ------------------------------------------------------------------------
    // ------------------------------------------------------------------------
    // Temperature Bean access fields below
    ...
    **/
    public double getFuelLevel(boolean estimate)
    {
        ...
        if (fuelLevel > 0.0) {
            Print.logDebug("Estimating FuelLevel based on device FuelLevelProfile");
            ...
            if ((fuelRemain > 0.0) && (fuelCapL > 0.0)) {
                Print.logDebug("Estimating FuelLevel based on device FuelRemaining/FuelCapacity");
    ...
    **/
    ...
    /**
    *** Gets the fuel remaining in tank #1 (in Litres)
    ...
    **/
    ...
    /**
    *** Sets the fuel remaining in tank #1 (in Litres)
    ...
    **/
    ...
    /**
    *** Gets the fuel remaining in tank #1 (in Litres)
    *** @param estimate True to estimate fuel remaining based on device tank #1 capacity and fuel level
    ...
    **/
    public double getFuelRemain(boolean estimate)
    {
        ...
        if (!estimate || (fuelRemain > 0.0)) {
            ...
            Device device     = this.getDevice(); // should not be null
            double fuelLevel  = this.getFuelLevel(false/*noEstimate*/); // tank #1
            double fuelCapL   = (device != null)? device.getFuelCapacity() : 0.0;
        ...
        throws DBException
    {
        ...
        try {
            if (EventData.LockTableOnRead()) {
                DBProvider.lockTables(new String[] { EventData.TABLE_NAME() }, null);
            }
  ...
  //private static final String KEY_TEMP_7[]          = new String[] { "temp7", "thermoAverage7"              };  // 47.3F
    ...
    **/
        ...
        if (EventData._keyMatch(key,EventData.KEY_FUEL_VOLUME2)) {
            if (getTitle) {
                ...
                if (device == null) {
                    ...
                    Account.VolumeUnits vu = Account.getVolumeUnits(ed.getAccount());
                    double L = device.getFuelCapacity() * ed.getFuelLevel2(); // TODO: Tank #2 capacity?
                    double V = vu.convertFromLiters(L);
                    return StringTools.format(V,"0.0") + " " + vu.toString(locale);
                }
            }
    ...
    private static final String ARG_UPDATE_ADDRESS[]    = new String[] { "updateAddress"            };
    ...
    public static void main(String argv[])
    {
        ...
        /* address length */
        if (RTConfig.getBoolean(ARG_ADDR_LEN,false)) {
