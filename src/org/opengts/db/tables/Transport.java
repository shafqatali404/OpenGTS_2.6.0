    ...
    implements DataTransport
{
    ...
    **/
    ...
    public void setTotalPingCount(int v)
    {
        ...
        if (this.assocDevice != null) {
            this.assocDevice._setTotalPingCount(v); // was "_setLastPingTime" [v2.5.7-B11]
        }
    }
        ...
        if (this.assocDevice == null) {
            ...
            try {
                if (!StringTools.isBlank(devID)) {
                    this.assocDevice = Device.getDevice(this.getAssocAccount(), devID); // null if non-existent
                    if (this.assocDevice != null) {
