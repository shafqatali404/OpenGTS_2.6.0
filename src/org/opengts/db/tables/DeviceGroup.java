    ...
    extends GroupRecord<DeviceGroup>
{
    ...
    public static final String  OPTCOLS_Miscellaneous       = "startupInit.DeviceGroup.Miscellaneous";
    ...
    public static final String FLD_parentGroupID        = "parentGroupID";            
    public static final DBField Miscellaneous[]         = {
      //new DBField(FLD_groupType    , Integer.TYPE  , DBField.TYPE_UINT16    , I18N.getString(DeviceGroup.class,"DeviceGroup.fld.groupType"    , "Device Group Type"        ), "edit=2"),
        new DBField(FLD_parentGroupID, String.class  , DBField.TYPE_GROUP_ID(), I18N.getString(DeviceGroup.class,"DeviceGroup.fld.parentGroupID", "Parent GroupID"           ), "edit=2"),
    };
    ...
    public static DBFactory<DeviceGroup> getFactory()
    {
        if (factory == null) {
            ...
            DeviceGroup.NotifyEmailColumnLength = (emailFld != null)? emailFld.getStringLength() : 0;
        }
        return factory;
    }
    ...
    {
        Integer v = (Integer)this.getOptionalFieldValue(FLD_groupType);
    ...
    {
        this.setOptionalFieldValue(FLD_groupType, v);
    }
    ...
    *** @return The parent groupID
    **/
    public String getParentGroupID()
    {
        String v = (String)this.getOptionalFieldValue(FLD_parentGroupID);
        return StringTools.trim(v);
    }

    /**
    *** Sets the Parent Group ID
    *** @param v  The parent groupID
    **/
    public void seParentGroupID(String v)
    {
        this.setOptionalFieldValue(FLD_parentGroupID, StringTools.trim(v));
    }
    ...
    **/
    public void setNotifyEmail(String v)
    {
        ...
        if ((DeviceGroup.NotifyEmailColumnLength > 0)           &&
            (ne.length() >= DeviceGroup.NotifyEmailColumnLength)  ) {
            int newLen = DeviceGroup.getMaximumNotifyEmailLength();
    ...
    **/
    public static int getMaximumNotifyEmailLength()
    {
        ...
        return DeviceGroup.NotifyEmailColumnLength - 1;
    }
    ...
    **/
        ...
        throws DBException
    {
        ...
        for (String devID : devList) {
            ...
            /* short sleep before counting/deleting next set of events */
            if (devCount > 0) {
                long sleepMS = 500L;
    ...
    **/
    ...
    /* return list of all Devices within the specified DeviceGroup (may not be scalable) */
