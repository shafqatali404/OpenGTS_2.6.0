...
public class DCServerFactory
{
    ...
    **/
    ...
    /* return Garmin description for "Message Status" */
    public static String Garmin_getMessageStatusDescription(Locale locale, int msgStatus)
    {
        I18N i18n = I18N.getI18N(DCServerFactory.class, locale);
        switch (msgStatus) {
            case 0:  // Unread    [GFMI.MESSAGE_unread]
                return i18n.getString("DCServerFactory.garminMessageStatus.unread"  , "Unread");
            case 1:  // Read      [GFMI.MESSAGE_read]
                return i18n.getString("DCServerFactory.garminMessageStatus.read"    , "Read");
            case 2:  // Not Found [GFMI.MESSAGE_notFound]
                return i18n.getString("DCServerFactory.garminMessageStatus.notFound", "Not Found");
            default: // Unknown
                return i18n.getString("DCServerFactory.garminMessageStatus.unknown" , "Unknown");
        }
    }
    ...
    **/
    public enum ResultCode implements EnumTools.StringLocale, EnumTools.StringValue {
        ...
        IGNORED_SMS      ("PR003",I18N.getString(DCServerFactory.class,"DCServerFactory.result.ignoredSmsNumber","Ignored SMS number")),
  ...
  //private static final String ATTR_portOffset         = "portOffset";
    ...
    **/
        ...
        boolean saveUnassigned, String serverID, String ipAddress, boolean isDuplex, GeoPoint geoPoint)
    {
        ...
        try {
            ...
            /* auto-add device? */
            if (device == null) {
                Account acct = Account.getGlobalAccount();
                if ((acct != null) && acct.okToAutoAddDevice()) {
                    // -- Create a 'Device'
                    try {
                        Device dev = Device.getDevice(acct, modemID, true); // create (does not return null)
                        dev.setUniqueID(uniqueID);
                        dev.setDescription(acct.getNewDeviceDescription(null,modemID));
                        dev.save();
                        device = dev; // set only after no chance of an Exception
                        Print.logInfo("Auto-Add new Device '"+device+"'");
                    } catch (DBException dbe) {
                        // -- unable to create Device
                        Print.logError("Unable to Auto-Add Device: " + dbe);
                        device = null; // redundant
                    }
                }
            }
    ...
    **/
    ...
    public static final String  CFG_minimumSatelliteCount       = ".minimumSatelliteCount";      // int
    ...
    public static final String  CFG_fuelLevelProfile            = ".fuelLevelProfile";           // FuelLevelProfile
    public static final String  CFG_batteryLevelProfile         = ".batteryLevelProfile";        // BatteryLevelProfile
    public static final String  CFG_eventDataAnalog_            = ".analog.";                    // EventDataAnalog
    ...
    *** @param name  The server name
    *** @return An array of "Minimum Satellite Count" names
    **/
    public static String[] CONFIG_minimumSatelliteCount(String name)
    {
        return new String[] { 
            PROP_DCServer_ + name + CFG_minimumSatelliteCount,
            name + CFG_minimumSatelliteCount
        };
    }
    ...
    *** @param name  The server name
    *** @return An array of "FuelLevelProfile" property names
    **/
    public static String[] CONFIG_fuelLevelProfile(String name)
    {
        return new String[] { 
            PROP_DCServer_ + name + CFG_fuelLevelProfile,
            name + CFG_fuelLevelProfile,
            PROP_DCServer_ + name + CFG_fuelLevelProfile + ".1",
            name + CFG_fuelLevelProfile + ".1"
        };
    }
    ...
    *** @return An array of "FuelLevelProfile" property names
    **/
    public static String[] CONFIG_fuelLevelProfile2(String name)
    {
        return new String[] { 
            PROP_DCServer_ + name + CFG_fuelLevelProfile + ".2",
            name + CFG_fuelLevelProfile + ".2"
        };
    }
    ...
    *** @param name  The server name
    *** @return An array of "BatteryLevelProfile" property names
    **/
    public static String[] CONFIG_batteryLevelProfile(String name)
    {
        return new String[] { 
            PROP_DCServer_ + name + CFG_batteryLevelProfile,
            name + CFG_batteryLevelProfile,
        };
    }
    ...
    *** @param name  The server name
    *** @param aNdx  The 1-based analog index
    *** @return An array of "EventDataAnalog" property names
    **/
    public static String[] CONFIG_eventDataAnalog(String name, int aNdx)
    {
        return new String[] { 
            PROP_DCServer_ + name + CFG_eventDataAnalog_ + aNdx, 
            name + CFG_eventDataAnalog_ + aNdx,
        };
    }
    ...
    private static final String ARG_PROPERTIES[]        = new String[] { "properties"   , "props"      };
    ...
    **/
    public static void main(String args[])
    {
        ...
        // -------------------------------------------------------
        // -- DCS name required beyond this point
        ...
        /* DCS properties */
        if (RTConfig.getBoolean(ARG_PROPERTIES,false)) {
            Set<String> propNames = dcs.getPropertyGroupNames();
            Print.sysPrintln("Property group names:");
            for (String pid : propNames) {
        ...
        // -------------------------------------------------------
        // -- command required beyond this point
        ...
        // -------------------------------------------------------
        // -- Account/Device required beyond this point
